...
Add a markdown file to `src/content/writing/` — for example `clinical-ai-radiology-notes.md`. The file's name (minus the `.md`) becomes its URL slug, so this post lives at `/writing/welcome/`.
